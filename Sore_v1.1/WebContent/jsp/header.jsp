		...
		<div class="col-md-3" style="padding-top: 20px">
			<ol class="list-inline">
				...
				<c:if test="${  not empty userLogin }">
					<li><a
						href="${pageContext.request.contextPath}/UserServlet?method=userLogOut">退出</a></li>
					<li><a
						href="${pageContext.request.contextPath}/UserServlet?method=userLogOut">我的订单</a></li>
					<li><a href="${pageContext.request.contextPath}/jsp/cart.jsp">购物车</a></li>
					<li><a
						href="${pageContext.request.contextPath}/OrdersServlet?method=findMyOrdersWithPage&num=1">我的订单</a></li>
