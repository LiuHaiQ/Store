...
public class MailUtils {
	...
	public static void sendMail(String email, String emailMsg) {
		try {
			...
			props.put("mail.password", "oqeeucjlruoabehf");
		...
		long currentTime= System.currentTimeMillis();
			...
			String url="sthttp://localho:8080/Sore_v1.0/UserServlet?method=active&code="+emailMsg;
			...
			sb.append("<div class=\"story\">" +  content + "</div>");
