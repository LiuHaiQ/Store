...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<form id="form1" action="${pageContext.request.contextPath}/CartServlet?method=addCartgItemToCart" method="post">
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">${product.shop_price }</strong>
						参 考 价：
					...
					<div
						...
						<div
							...
							购买数量: <input id="quantity" name="count"
...
$(function (){
	$("#btnID").click(function(){
		var formobj=doucment.getElementById("form1");
		formobj.action("/Sore_v1.1/CartServlet")
		formobj.method="post";
		formobj.submit();
	});
})
