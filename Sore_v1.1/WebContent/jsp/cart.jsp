...
<div class="container">
				...
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${cart.getCarItems() }" var="cartItem">
							<tr class="active">
								...
								<td width="10%">
									<input type="text" name="quantity" value="${cartItem.getCount() }" maxlength="4" size="10">
								</td>
								<td width="15%">
									<span class="subtotal">${cartItem.subtotal }</span>
								</td>
								<td>
									<a href="${pageContext.request.contextPath}/CartServlet?method=removeCartgItemToCart&pid=${cartItem.product.pid }" class="delete">删除</a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath}/CartServlet?method=clearCartgItemToCart" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath}/OrdersServlet?method=savaOrders">
						<%--提交表单 --%>
