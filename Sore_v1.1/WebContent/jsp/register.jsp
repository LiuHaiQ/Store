...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=registUI" method="post" style="margin-top:5px;">
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="number" class="form-control" name="telephone" id="inputEmail3" placeholder="手机号码">
			    </div>
			  </div>
			 <div class="form-group">
