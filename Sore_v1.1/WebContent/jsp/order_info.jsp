	...
	<div class="container">
		<div class="row">
			...
			<div style="text-align: right; margin-right: 120px;">
				商品金额: <strong style="color: #ff6600;">￥${orders.total }</strong>
			</div>
		...
		<div>
			...
			<form class="form-horizontal"
				style="margin-top: 5px; margin-left: 150px;" id="orderForm" action="${pageContext.request.contextPath}/OrdersServlet?method=payOrder&" method="post">
